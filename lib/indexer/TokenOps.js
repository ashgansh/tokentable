...
const getAvailableAmounts = async (contract, tokenAddress) => {
  return { [tokenAddress]: await contract.getWithdrawableAmount() }
}
...
export const getVestingData = async (chainId, contractAddress) => {
  ...
  const availableAmounts = await getAvailableAmounts(contract, tokenAddress)
