...
import { getVestingData as getSablierMeritVestingData } from "@/lib/indexer/SablierMerit.ts";
...
const VESTING_CONTRACT_INDEXERS = {
  ...
  sabliermerit: getSablierMeritVestingData,
...
const VESTING_CONTRACT_ABIS = {
  ...
  [objectHash(SABLIER_MERIT_CONTRACT_ABI)]: "sabliermerit",
};
