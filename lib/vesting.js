...
import { getVestingData as getDssVestVestingData } from "@/lib/indexer/DssVest";
...
export const getVestingContractDetails = async (chainId, contractAddress) => {
  ...
  const meta = VESTING_CONTRACTS.find(contract => contract.chainId === chainId && contract.contractAddress === formattedContractAddress)
